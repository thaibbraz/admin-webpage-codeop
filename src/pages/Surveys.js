  ...
  return (
    <div className="App">
      <div className="container mx-auto p-4">
        ...
        <h1 className="mb-12 text-3xl font-semibold text-center">Surveys</h1>
          ...
          <div className="py-8">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <Link
                ...
                to="/admin/surveys/weekly-survey"
              >
                Weekly survey
              </Link>
              <Link
                className="shadow-md border-2 hover:border-blue-500 rounded-lg p-4 text-blueGray-700 rext-xs uppercase"
                to="/admin/surveys/module-survey"
              >
                Post Module Survey
              </Link>
              <Link
                className="shadow-md border-2 hover:border-blue-500 rounded-lg p-4 text-blueGray-700 rext-xs uppercase"
                to="/admin/surveys/guest-speaker"
              >
                Guest Speaker
              </Link>
              <Link
